...
export default function MdRevertHistory() {
  ...
  const fetchRevertTransactions = async () => {
    if (!masterDistributorId) {
      toast.error("Master Distributor ID not found. Please login again.");
      return;
    }
  ...
  const exportToExcel = () => {
    try {
      ...
      const filename = `MD_Revert_Transactions_${timestamp}.xlsx`;
  ...
  const userTypeCounts = {
    masterDistributor: filteredTransactions.filter(t => getUserType(t.revert_on_id) === "Master Distributor").length,
    distributor: filteredTransactions.filter(t => getUserType(t.revert_on_id) === "Distributor").length,
                ...
                <CardContent className="p-6">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-2xl font-bold text-foreground">{userTypeCounts.distributor}</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
                ...
                <CardContent className="p-6">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-2xl font-bold text-foreground">{userTypeCounts.retailer}</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
