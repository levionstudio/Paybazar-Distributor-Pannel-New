...
const MdFundDistributor = () => {
  ...
  const fetchDistributorDetails = async (distributorId: string) => {
    ...
    try {
      const endpoint = `${import.meta.env.VITE_API_BASE_URL}/distributor/get/distributor/${distributorId}`;

      console.log("Fetching distributor details from:", endpoint);
      ...
      if (response.ok && data.status === "success") {
        ...
        console.error("Failed to fetch distributor details:", data);
        toast({
          title: "Error",
          description: data.message || "Failed to load distributor details",
          variant: "destructive",
        });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Payload for fund transfer from master distributor to distributor
    const payload = {
      from_id: tokenData.user_id,           // Master Distributor's user_id
      to_id: selectedDistributorId,         // Distributor's distributor_id
      amount: amountValue,
    ...
    try {
      ...
      toast({
        ...
        description: data.message || "Funds transferred to distributor successfully.",
      });
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-white/80">
                Transfer funds to distributor's wallet
              </p>
            </div>
          </div>
        </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <CardTitle className="text-xl font-semibold">
                    Add Funds to Distributor
                  </CardTitle>
                  <CardDescription className="mt-1 text-white/90">
                    Select distributor to transfer funds
                  </CardDescription>
                </div>
              </div>
            </CardHeader>
                  ...
                  <div className="rounded-xl border-2 border-green-200 bg-green-50 p-6 dark:border-green-800 dark:bg-green-950/20">
                    ...
                    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                      <div className="rounded-lg bg-white p-3 dark:bg-green-900/20">
                        ...
                        <p className="mt-1 break-words text-sm font-semibold text-green-900 dark:text-green-100">
                      ...
                      <div className="rounded-lg bg-white p-3 dark:bg-green-900/20">
                        ...
                        <p className="mt-1 break-all text-sm font-mono font-semibold text-green-900 dark:text-green-100">
                      ...
                      <div className="rounded-lg bg-white p-3 dark:bg-green-900/20">
                        ...
                        <p className="mt-1 text-sm font-bold text-green-600 dark:text-green-400">
                          ₹{distributorDetails.currentBalance.toLocaleString("en-IN", {
                            minimumFractionDigits: 2,
                            maximumFractionDigits: 2,
                          })}
                        </p>
